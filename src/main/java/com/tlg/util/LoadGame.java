...
import static com.tlg.util.GameState.action;
import static com.tlg.util.InputHandling.clearScreen;
import static com.tlg.util.InputHandling.runCommand;
import static com.tlg.util.Menu.inOffice;
    ...
    public static void load() throws IOException {
        ...
        do {
            if (inOffice.contains(currentLocation.getLocationName())) {
                ...
                Redirect.sendAppToGui("Your available directions of travel are:\nNorth= " + currentLocation.getNorth() +
